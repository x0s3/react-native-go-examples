...
find "$PWD/src/turbomodules" -name "Native*.ts" -print | xargs yarn flow-node packages/react-native-codegen/src/cli/combine/combine-js-to-schema-cli.js schema-turbomodules.json
