...
const _require2 = require('./properties'),
  getElementTypeForArrayOrObject = _require2.getElementTypeForArrayOrObject,
  getObjectProperties = _require2.getObjectProperties; // $FlowFixMe there's no flowtype for ASTs
