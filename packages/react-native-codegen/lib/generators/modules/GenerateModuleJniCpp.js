...
function translateReturnTypeToKind(typeAnnotation) {
...
function translateParamTypeToJniType(param, aliases) {
...
function translateReturnTypeToJniType(typeAnnotation) {
  const nullable = typeAnnotation.nullable;
...
function translateMethodTypeToJniSignature(property, aliases) {
  const name = property.name,
    typeAnnotation = property.typeAnnotation;
  const returnTypeAnnotation = typeAnnotation.returnTypeAnnotation;
...
function translateMethodForImplementation(property, aliases) {
  const returnTypeAnnotation = property.typeAnnotation.returnTypeAnnotation;
