...
const _require2 = require('./ObjCppUtils/Utils'),
  flatObjects = _require2.flatObjects;

const _require3 = require('./Utils'),
  getTypeAliasTypeAnnotation = _require3.getTypeAliasTypeAnnotation;
...
function translateMethodForImplementation(property) {
                    ...
                    property.typeAnnotation.params
                      .map(param => {
                        if (
                          ...
                          const properties = param.typeAnnotation.properties;
